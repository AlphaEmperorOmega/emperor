...
class MatrixBiasMixture(Module):
    VALIDATOR = MatrixBiasMixtureValidator
    ...
    def forward(
        ...
        self.VALIDATOR.validate_forward_inputs(self, bias_params, context)
        ...
        decayed_parameters = self._decay_policy(bias_params)
