...
class TerminalConfig(ConfigBase):
    ...
    x_axis_position: int | None = optional_field("Current neuron x-axis coordinate.")
    y_axis_position: int | None = optional_field("Current neuron y-axis coordinate.")
    z_axis_position: int | None = optional_field("Current neuron z-axis coordinate.")
...
class NeuronConfig(ConfigBase):
    ...
    axons_config: AxonsConfig | None = optional_field("Axons stage configuration.")
