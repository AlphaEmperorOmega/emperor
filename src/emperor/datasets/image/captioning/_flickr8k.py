...
class Flickr8k(DataModule):
    ...
    def __init__(
        ...
        root: str = "data/flickr8k",
        train_ann_file: str = "data/flickr8k/captions_train.token",
        val_ann_file: str = "data/flickr8k/captions_val.token",
    ):
    ...
    def prepare_data(self) -> None:
        pass  # Flickr8k requires manual download

    def _setup_fit(self) -> None:
        raw_train = datasets.Flickr8k(
            root=self.root,
            ann_file=self.train_ann_file,
            transform=self._get_transforms(),
        )
        self._build_vocab(raw_train)
        raw_val = datasets.Flickr8k(
            root=self.root,
