...
def WikiText103Dataset(*, root: str, split: str) -> Iterable[str]:
...
class WikiText103(DataModule):
    ...
    def _dataset(self, split: str):
        ...
        return WikiText103Dataset(root=self.root, split=split)
    ...
    def _load_legacy_split_tokens(self) -> dict[str, tuple[str, ...]]:
        ...
        datasets = WikiText103Dataset.splits(field, root=self.root)
