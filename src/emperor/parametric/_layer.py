...
from emperor.parametric._config import AdaptiveRouterOptions, ParametricLayerConfig
...
class ParametricLayer(Module):
    ...
    def __sample_vector_probabilities_and_indices(
        ...
        probabilities, indices, flat_skip_mask, loss = (
            self.sampler.sample_probabilities_and_indices(flat_logits, flat_skip_mask)
        )
