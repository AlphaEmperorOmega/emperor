# The Workbench inspects this module namespace to discover concrete configuration
# choices, so these imports are intentional metadata exports.
# ruff: noqa: F401
...
# Main Adaptive Parameter Grouping
# Choose group_count or chunk_size; internal padding never changes real row counts.
...
# Router Adaptive Parameter Grouping
# Choose group_count or chunk_size; internal padding never changes real row counts.
...
# Input Layer Adaptive Parameter Grouping
# Choose group_count or chunk_size; internal padding never changes real row counts.
...
# Output Layer Adaptive Parameter Grouping
# Choose group_count or chunk_size; internal padding never changes real row counts.
