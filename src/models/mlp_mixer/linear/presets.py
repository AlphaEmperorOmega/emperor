...
import models.mlp_mixer.linear.config as config
import models.mlp_mixer.linear.dataset_options as dataset_options
...
from .config_builder import MlpMixerLinearConfigBuilder
...
_PRESET_DEFINITIONS = {
    ExperimentPreset.BASELINE: PresetDefinition(
        preset_values={},
        description=(
            "Eight pre-normalized MLP-Mixer blocks with linear token and channel "
            "mixers, mean pooling, and no class token or positional embedding."
        ),
    ),
