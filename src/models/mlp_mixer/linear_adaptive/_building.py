...
def _token_mixing_model(runtime: RuntimeOptions, tokens: int):
    return _affine_stack(
        ...
        bias_flag=runtime.token_mixer_bias_flag,
        control_options=token_mixer_control_options(runtime),
        control_name="token_mixer",
    )
...
def _channel_mixing_model(runtime: RuntimeOptions):
    return _affine_stack(
        ...
        bias_flag=runtime.channel_mixer_bias_flag,
        mirrored=True,
        control_options=channel_mixer_control_options(runtime),
        control_name="channel_mixer",
    )
...
def _configure_controls(
    ...
    *,
    ...
    control_stack.shared_halting_config = _configured_halting(
        runtime,
        options=options.halting,
        defaults=defaults,
        model_dim=model_dim,
    )
    control_stack.shared_memory_config = _configured_memory(
        runtime,
