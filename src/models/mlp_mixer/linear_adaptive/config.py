...
# Adaptive mixer parameters. These options apply to adaptive affine layers in both
# token and channel mixers; patch projection and classification remain ordinary.
