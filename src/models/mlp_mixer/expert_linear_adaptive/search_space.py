...
# Adaptive expert parameters
SEARCH_SPACE_ADAPTIVE_GENERATOR_STACK_HIDDEN_DIM: list = [16, 32, 64]

# Expert routing
SEARCH_SPACE_TOP_K: list = [1, 2]
SEARCH_SPACE_NUM_EXPERTS: list = [2, 4, 8]
