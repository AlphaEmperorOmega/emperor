...
class RuntimeOptions:
    ...
    router_stack_residual_model_flag: bool = field(default=False, kw_only=True)
    router_stack_residual_block_size: int | None = field(default=None, kw_only=True)
    router_stack_residual_rms_norm_epsilon: float | None = field(
        default=None, kw_only=True
    )
    ...
    expert_stack_normalization: NormalizationOptions = field(
        default=NormalizationOptions.RMS_NORM, kw_only=True
    )
    ...
    expert_gate_stack_residual_block_size: int | None = field(
        default=None, kw_only=True
    )
    expert_gate_stack_residual_rms_norm_epsilon: float | None = field(
        default=None, kw_only=True
    )
    ...
    expert_halting_stack_residual_block_size: int | None = field(
        default=None, kw_only=True
    )
    expert_halting_stack_residual_rms_norm_epsilon: float | None = field(
        default=None, kw_only=True
    )
    ...
    expert_memory_stack_residual_block_size: int | None = field(
        default=None, kw_only=True
    )
    expert_memory_stack_residual_rms_norm_epsilon: float | None = field(
        default=None, kw_only=True
    )
    ...
    expert_recurrent_residual_connection_option: type[ResidualConfig] | None
    expert_recurrent_residual_model_flag: bool = field(default=False, kw_only=True)
    expert_recurrent_residual_block_size: int | None = field(default=None, kw_only=True)
    expert_recurrent_residual_rms_norm_epsilon: float | None = field(
        default=None, kw_only=True
    )
    ...
    expert_recurrent_gate_stack_residual_model_flag: bool = field(
        default=False, kw_only=True
    )
    expert_recurrent_gate_stack_residual_block_size: int | None = field(
        default=None, kw_only=True
    )
    expert_recurrent_gate_stack_residual_rms_norm_epsilon: float | None = field(
        default=None, kw_only=True
    )
    ...
    expert_recurrent_halting_stack_residual_model_flag: bool = field(
        default=False, kw_only=True
    )
    expert_recurrent_halting_stack_residual_block_size: int | None = field(
        default=None, kw_only=True
    )
    expert_recurrent_halting_stack_residual_rms_norm_epsilon: float | None = field(
        default=None, kw_only=True
    )
