...
def runtime_from_config() -> RuntimeOptions:
    ...
    return RuntimeOptions(
        ...
        attention_projection_adaptive_options=adaptive,
        attention_expert_adaptive_options=adaptive,
        router_adaptive_options=adaptive,
...
def runtime_from_flat(
    ...
    adaptive_groups = {
        "attention_projection_adaptive_": values.pop(
            "attention_projection_adaptive_options",
            runtime.attention_projection_adaptive_options,
        ),
        "attention_expert_adaptive_": values.pop(
            "attention_expert_adaptive_options",
            runtime.attention_expert_adaptive_options,
        ),
        "router_adaptive_": values.pop(
            "router_adaptive_options", runtime.router_adaptive_options
        ),
        "feed_forward_adaptive_": values.pop(
    ...
    for prefix, current in adaptive_groups.items():
        updates = dict(adaptive_broadcast)
