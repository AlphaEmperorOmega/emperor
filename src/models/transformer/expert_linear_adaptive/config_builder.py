...
class TransformerExpertLinearAdaptiveConfigBuilder:
    def __init__(
        self,
        *,
    ...
    def build(self) -> ModelConfig:
        ...
        return ModelConfig(
            ...
            sequence_length=max(
                runtime.source_sequence_length,
                runtime.target_sequence_length,
            ),
...
__all__ = ["TransformerExpertLinearAdaptiveConfigBuilder"]
