...
FF_RECURRENT_GATE_STACK_RESIDUAL_CONNECTION_OPTION: type[ResidualConfig] | None = (
    None
)
...
ATTENTION_PROJECTION_ADAPTIVE_WEIGHT_OPTION: type[DynamicWeightConfig] | None = None
ATTENTION_PROJECTION_ADAPTIVE_BIAS_OPTION: type[DynamicBiasConfig] | None = None
ATTENTION_PROJECTION_ADAPTIVE_DIAGONAL_OPTION: type[DynamicDiagonalConfig] | None = None
ATTENTION_PROJECTION_ADAPTIVE_ROW_MASK_OPTION: type[AxisMaskConfig] | None = None

ATTENTION_EXPERT_ADAPTIVE_WEIGHT_OPTION: type[DynamicWeightConfig] | None = None
ATTENTION_EXPERT_ADAPTIVE_BIAS_OPTION: type[DynamicBiasConfig] | None = None
ATTENTION_EXPERT_ADAPTIVE_DIAGONAL_OPTION: type[DynamicDiagonalConfig] | None = None
ATTENTION_EXPERT_ADAPTIVE_ROW_MASK_OPTION: type[AxisMaskConfig] | None = None

ROUTER_ADAPTIVE_WEIGHT_OPTION: type[DynamicWeightConfig] | None = None
ROUTER_ADAPTIVE_BIAS_OPTION: type[DynamicBiasConfig] | None = None
ROUTER_ADAPTIVE_DIAGONAL_OPTION: type[DynamicDiagonalConfig] | None = None
ROUTER_ADAPTIVE_ROW_MASK_OPTION: type[AxisMaskConfig] | None = None
