...
def runtime_from_config() -> RuntimeOptions:
    ...
    feed_forward_adaptive = adaptive_options_from_config(
        config,
...
def _resolve_adaptive_groups(
    ...
    groups = {
        "projection": runtime.projection_adaptive_options,
...
def _reject_unknown_runtime_default(values: MutableMapping[str, Any]) -> None:
    if values:
        ...
        raise TypeError(
            "TransformerLinearAdaptiveConfigBuilder.__init__() got an "
            "unexpected keyword "
...
def runtime_from_flat(
    ...
    return replace(
        ...
        projection_adaptive_options=adaptive_groups["projection"],
