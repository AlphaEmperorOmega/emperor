...
def _load_expert_adapter_dependencies() -> None:
    ...
    from models.bert.expert_linear_adaptive import _expert_adapter_support as adapter
    from models.bert.expert_linear_adaptive import runtime_options as options
