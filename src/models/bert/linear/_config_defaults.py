...
class _ConfigDefaults(Protocol):
    ENCODER_OUTPUT_NORMALIZATION: NormalizationOptions
    ...
    MLM_ACTIVATION: ActivationOptions
    MLM_DENSE_BIAS_FLAG: bool
    MLM_LAYER_NORM_FLAG: bool
    MLM_NORMALIZATION: NormalizationOptions
    MLM_DECODER_BIAS_FLAG: bool
    MLM_DECODER_WEIGHT_TYING_FLAG: bool
    NSP_POOLER_ACTIVATION: ActivationOptions
    NSP_POOLER_BIAS_FLAG: bool
    NSP_OUTPUT_DIM: int
    NSP_HEAD_BIAS_FLAG: bool
...
def bert_embedding_options(config: _ConfigDefaults) -> BertEmbeddingOptions:
...
def bert_mlm_head_options(config: _ConfigDefaults) -> BertMlmHeadOptions:
...
def bert_nsp_head_options(config: _ConfigDefaults) -> BertNspHeadOptions:
...
def bert_encoder_options(config: _ConfigDefaults) -> TransformerEncoderOptions:
...
def bert_attention_options(config: _ConfigDefaults) -> TransformerAttentionOptions:
