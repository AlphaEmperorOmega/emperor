...
from models.bert.expert_linear._bert_expert_config_factory import (
    BertExpertConfigDependencies as _ExpertDependencies,
)
from models.bert.expert_linear._bert_expert_config_factory import (
    BertExpertConfigFactory,
)
...
class ExpertConfigFactory:
    ...
    def __default_encoder_options(
        ...
        return config_defaults.bert_encoder_options(config_module)
    ...
    def __default_attention_options(
        ...
        return config_defaults.bert_attention_options(config_module)
    ...
    def __default_feed_forward_options(
        ...
        return config_defaults.bert_feed_forward_options(config_module)
    ...
    def __expert_config_factory(self) -> BertExpertConfigFactory:
        dependencies = self.dependencies
        return BertExpertConfigFactory(
            _ExpertDependencies(
