...
from models.vit.expert_linear_adaptive._control_factory_dependencies import (
    VitControlFactoryDependencies,
)
from models.vit.expert_linear_adaptive._encoder_control_config_factory import (
...
class VitCoreConfigFactory:
    ...
    def _stack_residual_connection_option(self) -> type[ResidualConfig] | None:
