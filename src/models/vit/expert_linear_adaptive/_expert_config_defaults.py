...
def main_controller_stack_defaults(
    ...
    if stack_role is ControllerStackRole.RECURRENT_GATE:
        return MainControllerStackDefaults(
            ...
            apply_output_pipeline_flag=config.RECURRENT_GATE_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
    ...
    return MainControllerStackDefaults(
        ...
        apply_output_pipeline_flag=config.RECURRENT_HALTING_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
...
_STACK_SOURCE_FACTORIES: Mapping[
...
] = MappingProxyType(
    {
        (
            ...
            apply_output_pipeline_flag=config.EXPERT_GATE_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        (
            ...
            apply_output_pipeline_flag=config.EXPERT_HALTING_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        (
            ...
            apply_output_pipeline_flag=config.EXPERT_MEMORY_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        (
            ...
            apply_output_pipeline_flag=config.EXPERT_RECURRENT_GATE_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        (
            ...
            apply_output_pipeline_flag=config.EXPERT_RECURRENT_HALTING_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        (
            ...
            apply_output_pipeline_flag=config.ROUTER_GATE_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        (
            ...
            apply_output_pipeline_flag=config.ROUTER_HALTING_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        (
            ...
            apply_output_pipeline_flag=config.ROUTER_MEMORY_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        (
            ...
            apply_output_pipeline_flag=config.ROUTER_RECURRENT_GATE_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        (
            ...
            apply_output_pipeline_flag=config.ROUTER_RECURRENT_HALTING_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
