...
from Emperor.linears.utils.behaviours import DynamicDiagonalBehaviour
...
class TestDynamicBiasBehaviour(TestLinearsDiagonalBehaviour):
    def get_model(self):
        return DynamicDiagonalBehaviour(self.cfg)
