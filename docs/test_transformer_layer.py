                            ...
                            for average_attention_weights_flag in bool_options:
                                for causal_attention_mask_flag in bool_options:
                                    c = TransformerPresets.transformer_preset(
                                        ...
                                        # attention_causal_attention_mask_flag=causal_attention_mask_flag,
                                    )
