...
from models.experts.experts_linear_adaptive import Experiment, ExperimentPreset

if __name__ == "__main__":
    parser = get_experiment_parser(ExperimentPreset.names(), "models.experts.experts_linear_adaptive")
