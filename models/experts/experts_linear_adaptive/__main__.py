...
from models.experts.experts_linear_adaptive import Experiment, ExperimentOptions

if __name__ == "__main__":
    parser = get_experiment_parser(ExperimentOptions.names(), "models.experts.experts_linear_adaptive")
