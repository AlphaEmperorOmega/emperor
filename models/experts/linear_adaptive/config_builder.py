...
class LinearAdaptiveConfigBuilder:
    def __init__(
        ...
        expert_gate_stack_layer_norm_position: LayerNormPositionOptions | None = config.EXPERT_GATE_STACK_LAYER_NORM_POSITION,
        expert_gate_stack_num_layers: int | None = config.EXPERT_GATE_STACK_NUM_LAYERS,
        expert_gate_stack_activation: ActivationOptions | None = config.EXPERT_GATE_STACK_ACTIVATION,
        expert_gate_stack_residual_connection_option: ResidualConnectionOptions | None = config.EXPERT_GATE_STACK_RESIDUAL_CONNECTION_OPTION,
        expert_gate_stack_dropout_probability: float | None = config.EXPERT_GATE_STACK_DROPOUT_PROBABILITY,
        expert_gate_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.EXPERT_GATE_STACK_LAST_LAYER_BIAS_OPTION,
        expert_gate_stack_apply_output_pipeline_flag: bool | None = config.EXPERT_GATE_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        expert_halting_stack_layer_norm_position: LayerNormPositionOptions | None = config.EXPERT_HALTING_STACK_LAYER_NORM_POSITION,
        expert_halting_stack_num_layers: int | None = config.EXPERT_HALTING_STACK_NUM_LAYERS,
        expert_halting_stack_activation: ActivationOptions | None = config.EXPERT_HALTING_STACK_ACTIVATION,
        expert_halting_stack_residual_connection_option: ResidualConnectionOptions | None = config.EXPERT_HALTING_STACK_RESIDUAL_CONNECTION_OPTION,
        expert_halting_stack_dropout_probability: float | None = config.EXPERT_HALTING_STACK_DROPOUT_PROBABILITY,
        expert_halting_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.EXPERT_HALTING_STACK_LAST_LAYER_BIAS_OPTION,
        expert_halting_stack_apply_output_pipeline_flag: bool | None = config.EXPERT_HALTING_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        expert_memory_test_time_training_learning_rate: float | None = config.EXPERT_MEMORY_TEST_TIME_TRAINING_LEARNING_RATE,
        expert_memory_test_time_training_num_inner_steps: int | None = config.EXPERT_MEMORY_TEST_TIME_TRAINING_NUM_INNER_STEPS,
        ...
        expert_memory_stack_layer_norm_position: LayerNormPositionOptions | None = config.EXPERT_MEMORY_STACK_LAYER_NORM_POSITION,
        expert_memory_stack_num_layers: int | None = config.EXPERT_MEMORY_STACK_NUM_LAYERS,
        expert_memory_stack_activation: ActivationOptions | None = config.EXPERT_MEMORY_STACK_ACTIVATION,
        expert_memory_stack_residual_connection_option: ResidualConnectionOptions | None = config.EXPERT_MEMORY_STACK_RESIDUAL_CONNECTION_OPTION,
        expert_memory_stack_dropout_probability: float | None = config.EXPERT_MEMORY_STACK_DROPOUT_PROBABILITY,
        expert_memory_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.EXPERT_MEMORY_STACK_LAST_LAYER_BIAS_OPTION,
        expert_memory_stack_apply_output_pipeline_flag: bool | None = config.EXPERT_MEMORY_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        expert_recurrent_gate_option: LayerGateOptions | None = config.EXPERT_RECURRENT_GATE_OPTION,
        expert_recurrent_gate_activation: ActivationOptions | None = config.EXPERT_RECURRENT_GATE_ACTIVATION,
        expert_recurrent_gate_stack_independent_flag: bool = config.EXPERT_RECURRENT_GATE_STACK_INDEPENDENT_FLAG,
        expert_recurrent_gate_stack_hidden_dim: int | None = config.EXPERT_RECURRENT_GATE_STACK_HIDDEN_DIM,
        expert_recurrent_gate_stack_layer_norm_position: LayerNormPositionOptions | None = config.EXPERT_RECURRENT_GATE_STACK_LAYER_NORM_POSITION,
        expert_recurrent_gate_stack_num_layers: int | None = config.EXPERT_RECURRENT_GATE_STACK_NUM_LAYERS,
        expert_recurrent_gate_stack_activation: ActivationOptions | None = config.EXPERT_RECURRENT_GATE_STACK_ACTIVATION,
        expert_recurrent_gate_stack_residual_connection_option: ResidualConnectionOptions | None = config.EXPERT_RECURRENT_GATE_STACK_RESIDUAL_CONNECTION_OPTION,
        expert_recurrent_gate_stack_dropout_probability: float | None = config.EXPERT_RECURRENT_GATE_STACK_DROPOUT_PROBABILITY,
        expert_recurrent_gate_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.EXPERT_RECURRENT_GATE_STACK_LAST_LAYER_BIAS_OPTION,
        expert_recurrent_gate_stack_apply_output_pipeline_flag: bool | None = config.EXPERT_RECURRENT_GATE_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        expert_recurrent_gate_stack_bias_flag: bool | None = config.EXPERT_RECURRENT_GATE_STACK_BIAS_FLAG,
        ...
        expert_recurrent_halting_stack_hidden_dim: int | None = config.EXPERT_RECURRENT_HALTING_STACK_HIDDEN_DIM,
        expert_recurrent_halting_stack_layer_norm_position: LayerNormPositionOptions | None = config.EXPERT_RECURRENT_HALTING_STACK_LAYER_NORM_POSITION,
        expert_recurrent_halting_stack_num_layers: int | None = config.EXPERT_RECURRENT_HALTING_STACK_NUM_LAYERS,
        expert_recurrent_halting_stack_activation: ActivationOptions | None = config.EXPERT_RECURRENT_HALTING_STACK_ACTIVATION,
        expert_recurrent_halting_stack_residual_connection_option: ResidualConnectionOptions | None = config.EXPERT_RECURRENT_HALTING_STACK_RESIDUAL_CONNECTION_OPTION,
        expert_recurrent_halting_stack_dropout_probability: float | None = config.EXPERT_RECURRENT_HALTING_STACK_DROPOUT_PROBABILITY,
        expert_recurrent_halting_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.EXPERT_RECURRENT_HALTING_STACK_LAST_LAYER_BIAS_OPTION,
        expert_recurrent_halting_stack_apply_output_pipeline_flag: bool | None = config.EXPERT_RECURRENT_HALTING_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        expert_recurrent_halting_stack_bias_flag: bool | None = config.EXPERT_RECURRENT_HALTING_STACK_BIAS_FLAG,
        ...
        weight_generator_stack_hidden_dim: int | None = config.WEIGHT_GENERATOR_STACK_HIDDEN_DIM,
        weight_generator_stack_layer_norm_position: LayerNormPositionOptions | None = config.WEIGHT_GENERATOR_STACK_LAYER_NORM_POSITION,
        weight_generator_stack_num_layers: int | None = config.WEIGHT_GENERATOR_STACK_NUM_LAYERS,
        weight_generator_stack_activation: ActivationOptions | None = config.WEIGHT_GENERATOR_STACK_ACTIVATION,
        weight_generator_stack_residual_connection_option: ResidualConnectionOptions | None = config.WEIGHT_GENERATOR_STACK_RESIDUAL_CONNECTION_OPTION,
        weight_generator_stack_dropout_probability: float | None = config.WEIGHT_GENERATOR_STACK_DROPOUT_PROBABILITY,
        weight_generator_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.WEIGHT_GENERATOR_STACK_LAST_LAYER_BIAS_OPTION,
        weight_generator_stack_apply_output_pipeline_flag: bool | None = config.WEIGHT_GENERATOR_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        weight_generator_stack_bias_flag: bool | None = config.WEIGHT_GENERATOR_STACK_BIAS_FLAG,
        ...
        bias_generator_stack_layer_norm_position: LayerNormPositionOptions | None = config.BIAS_GENERATOR_STACK_LAYER_NORM_POSITION,
        bias_generator_stack_num_layers: int | None = config.BIAS_GENERATOR_STACK_NUM_LAYERS,
        bias_generator_stack_activation: ActivationOptions | None = config.BIAS_GENERATOR_STACK_ACTIVATION,
        bias_generator_stack_residual_connection_option: ResidualConnectionOptions | None = config.BIAS_GENERATOR_STACK_RESIDUAL_CONNECTION_OPTION,
        bias_generator_stack_dropout_probability: float | None = config.BIAS_GENERATOR_STACK_DROPOUT_PROBABILITY,
        bias_generator_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.BIAS_GENERATOR_STACK_LAST_LAYER_BIAS_OPTION,
        bias_generator_stack_apply_output_pipeline_flag: bool | None = config.BIAS_GENERATOR_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        diagonal_generator_stack_hidden_dim: int | None = config.DIAGONAL_GENERATOR_STACK_HIDDEN_DIM,
        diagonal_generator_stack_layer_norm_position: LayerNormPositionOptions | None = config.DIAGONAL_GENERATOR_STACK_LAYER_NORM_POSITION,
        diagonal_generator_stack_num_layers: int | None = config.DIAGONAL_GENERATOR_STACK_NUM_LAYERS,
        diagonal_generator_stack_activation: ActivationOptions | None = config.DIAGONAL_GENERATOR_STACK_ACTIVATION,
        diagonal_generator_stack_residual_connection_option: ResidualConnectionOptions | None = config.DIAGONAL_GENERATOR_STACK_RESIDUAL_CONNECTION_OPTION,
        diagonal_generator_stack_dropout_probability: float | None = config.DIAGONAL_GENERATOR_STACK_DROPOUT_PROBABILITY,
        diagonal_generator_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.DIAGONAL_GENERATOR_STACK_LAST_LAYER_BIAS_OPTION,
        diagonal_generator_stack_apply_output_pipeline_flag: bool | None = config.DIAGONAL_GENERATOR_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        diagonal_generator_stack_bias_flag: bool | None = config.DIAGONAL_GENERATOR_STACK_BIAS_FLAG,
        ...
        mask_generator_stack_layer_norm_position: LayerNormPositionOptions | None = config.MASK_GENERATOR_STACK_LAYER_NORM_POSITION,
        mask_generator_stack_num_layers: int | None = config.MASK_GENERATOR_STACK_NUM_LAYERS,
        mask_generator_stack_activation: ActivationOptions | None = config.MASK_GENERATOR_STACK_ACTIVATION,
        mask_generator_stack_residual_connection_option: ResidualConnectionOptions | None = config.MASK_GENERATOR_STACK_RESIDUAL_CONNECTION_OPTION,
        mask_generator_stack_dropout_probability: float | None = config.MASK_GENERATOR_STACK_DROPOUT_PROBABILITY,
        mask_generator_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.MASK_GENERATOR_STACK_LAST_LAYER_BIAS_OPTION,
        mask_generator_stack_apply_output_pipeline_flag: bool | None = config.MASK_GENERATOR_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        ...
        input_layer_weight_option: type[DynamicWeightConfig] | None = config.INPUT_LAYER_WEIGHT_OPTION,
        ...
        input_layer_bias_option: type[DynamicBiasConfig] | None = config.INPUT_LAYER_BIAS_OPTION,
        ...
        input_layer_diagonal_option: type[DynamicDiagonalConfig] | None = config.INPUT_LAYER_DIAGONAL_OPTION,
        input_layer_row_mask_option: type[AxisMaskConfig] | None = config.INPUT_LAYER_ROW_MASK_OPTION,
        ...
        output_layer_weight_option: type[DynamicWeightConfig] | None = config.OUTPUT_LAYER_WEIGHT_OPTION,
        ...
        output_layer_bias_option: type[DynamicBiasConfig] | None = config.OUTPUT_LAYER_BIAS_OPTION,
        ...
        output_layer_diagonal_option: type[DynamicDiagonalConfig] | None = config.OUTPUT_LAYER_DIAGONAL_OPTION,
        output_layer_row_mask_option: type[AxisMaskConfig] | None = config.OUTPUT_LAYER_ROW_MASK_OPTION,
        ...
        router_weight_generator_stack_hidden_dim: int | None = config.ROUTER_WEIGHT_GENERATOR_STACK_HIDDEN_DIM,
        router_weight_generator_stack_layer_norm_position: LayerNormPositionOptions | None = config.ROUTER_WEIGHT_GENERATOR_STACK_LAYER_NORM_POSITION,
        router_weight_generator_stack_num_layers: int | None = config.ROUTER_WEIGHT_GENERATOR_STACK_NUM_LAYERS,
        router_weight_generator_stack_activation: ActivationOptions | None = config.ROUTER_WEIGHT_GENERATOR_STACK_ACTIVATION,
        router_weight_generator_stack_residual_connection_option: ResidualConnectionOptions | None = config.ROUTER_WEIGHT_GENERATOR_STACK_RESIDUAL_CONNECTION_OPTION,
        router_weight_generator_stack_dropout_probability: float | None = config.ROUTER_WEIGHT_GENERATOR_STACK_DROPOUT_PROBABILITY,
        router_weight_generator_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.ROUTER_WEIGHT_GENERATOR_STACK_LAST_LAYER_BIAS_OPTION,
        router_weight_generator_stack_apply_output_pipeline_flag: bool | None = config.ROUTER_WEIGHT_GENERATOR_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        router_weight_generator_stack_bias_flag: bool | None = config.ROUTER_WEIGHT_GENERATOR_STACK_BIAS_FLAG,
        ...
        router_bias_generator_stack_hidden_dim: int | None = config.ROUTER_BIAS_GENERATOR_STACK_HIDDEN_DIM,
        router_bias_generator_stack_layer_norm_position: LayerNormPositionOptions | None = config.ROUTER_BIAS_GENERATOR_STACK_LAYER_NORM_POSITION,
        router_bias_generator_stack_num_layers: int | None = config.ROUTER_BIAS_GENERATOR_STACK_NUM_LAYERS,
        router_bias_generator_stack_activation: ActivationOptions | None = config.ROUTER_BIAS_GENERATOR_STACK_ACTIVATION,
        router_bias_generator_stack_residual_connection_option: ResidualConnectionOptions | None = config.ROUTER_BIAS_GENERATOR_STACK_RESIDUAL_CONNECTION_OPTION,
        router_bias_generator_stack_dropout_probability: float | None = config.ROUTER_BIAS_GENERATOR_STACK_DROPOUT_PROBABILITY,
        router_bias_generator_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.ROUTER_BIAS_GENERATOR_STACK_LAST_LAYER_BIAS_OPTION,
        router_bias_generator_stack_apply_output_pipeline_flag: bool | None = config.ROUTER_BIAS_GENERATOR_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        router_bias_generator_stack_bias_flag: bool | None = config.ROUTER_BIAS_GENERATOR_STACK_BIAS_FLAG,
        router_diagonal_option_flag: bool | None = None,
        router_diagonal_option: type[DynamicDiagonalConfig] | None = config.ROUTER_DIAGONAL_OPTION,
        router_diagonal_generator_stack_independent_flag: bool = config.ROUTER_DIAGONAL_GENERATOR_STACK_INDEPENDENT_FLAG,
        router_diagonal_generator_stack_hidden_dim: int | None = config.ROUTER_DIAGONAL_GENERATOR_STACK_HIDDEN_DIM,
        router_diagonal_generator_stack_layer_norm_position: LayerNormPositionOptions | None = config.ROUTER_DIAGONAL_GENERATOR_STACK_LAYER_NORM_POSITION,
        router_diagonal_generator_stack_num_layers: int | None = config.ROUTER_DIAGONAL_GENERATOR_STACK_NUM_LAYERS,
        router_diagonal_generator_stack_activation: ActivationOptions | None = config.ROUTER_DIAGONAL_GENERATOR_STACK_ACTIVATION,
        router_diagonal_generator_stack_residual_connection_option: ResidualConnectionOptions | None = config.ROUTER_DIAGONAL_GENERATOR_STACK_RESIDUAL_CONNECTION_OPTION,
        router_diagonal_generator_stack_dropout_probability: float | None = config.ROUTER_DIAGONAL_GENERATOR_STACK_DROPOUT_PROBABILITY,
        router_diagonal_generator_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.ROUTER_DIAGONAL_GENERATOR_STACK_LAST_LAYER_BIAS_OPTION,
        router_diagonal_generator_stack_apply_output_pipeline_flag: bool | None = config.ROUTER_DIAGONAL_GENERATOR_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        router_diagonal_generator_stack_bias_flag: bool | None = config.ROUTER_DIAGONAL_GENERATOR_STACK_BIAS_FLAG,
        ...
        router_mask_generator_stack_hidden_dim: int | None = config.ROUTER_MASK_GENERATOR_STACK_HIDDEN_DIM,
        router_mask_generator_stack_layer_norm_position: LayerNormPositionOptions | None = config.ROUTER_MASK_GENERATOR_STACK_LAYER_NORM_POSITION,
        router_mask_generator_stack_num_layers: int | None = config.ROUTER_MASK_GENERATOR_STACK_NUM_LAYERS,
        router_mask_generator_stack_activation: ActivationOptions | None = config.ROUTER_MASK_GENERATOR_STACK_ACTIVATION,
        router_mask_generator_stack_residual_connection_option: ResidualConnectionOptions | None = config.ROUTER_MASK_GENERATOR_STACK_RESIDUAL_CONNECTION_OPTION,
        router_mask_generator_stack_dropout_probability: float | None = config.ROUTER_MASK_GENERATOR_STACK_DROPOUT_PROBABILITY,
        router_mask_generator_stack_last_layer_bias_option: LastLayerBiasOptions | None = config.ROUTER_MASK_GENERATOR_STACK_LAST_LAYER_BIAS_OPTION,
        router_mask_generator_stack_apply_output_pipeline_flag: bool | None = config.ROUTER_MASK_GENERATOR_STACK_APPLY_OUTPUT_PIPELINE_FLAG,
        router_mask_generator_stack_bias_flag: bool | None = config.ROUTER_MASK_GENERATOR_STACK_BIAS_FLAG,
            ...
            or ExpertsLayerControllerOptions(
                ...
                gate_stack_source=ExpertsSubmoduleStackSource(
                    ...
                    last_layer_bias_option=(
                        expert_gate_stack_last_layer_bias_option
                    ),
        ...
        expert_dynamic_memory_options = (
            ...
            or ExpertsDynamicMemoryOptions(
                ...
                memory_stack_source=ExpertsSubmoduleStackSource(
                    ...
                    last_layer_bias_option=(
                        expert_memory_stack_last_layer_bias_option
                    ),
                    apply_output_pipeline_flag=(
        ...
        input_boundary_options = input_boundary_options or AdaptiveBoundaryProjectionOptions(
        ...
        output_boundary_options = output_boundary_options or AdaptiveBoundaryProjectionOptions(
        ...
        self.expert_halting_dropout = (
            expert_layer_controller_options.halting_dropout
        )
        ...
        self.expert_recurrent_flag = (
            expert_recurrent_controller_options.recurrent_flag
        )
