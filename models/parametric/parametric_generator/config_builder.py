...
class ParametricGeneratorConfigBuilder:
    def __init__(
        ...
        self.generator_stack_num_layers = generator_stack_num_layers
        self.generator_stack_hidden_dim = generator_stack_hidden_dim
        self.generator_stack_activation = generator_stack_activation
        self.generator_stack_dropout_probability = generator_stack_dropout_probability
        ...
        return ModelConfig(
            ...
            experiment_config=ExperimentConfig(
                ...
                model_config=build_parametric_stack_config(
                    ...
                    generator_stack_num_layers=self.generator_stack_num_layers,
                    generator_stack_hidden_dim=self.generator_stack_hidden_dim,
                    generator_stack_activation=self.generator_stack_activation,
