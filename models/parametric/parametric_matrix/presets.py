...
class ExperimentPresets(ExperimentPresetsBase):
    ...
    def _preset(
        ...
        adaptive_bias_option: type[MatrixBiasMixtureConfig] | None = config.ADAPTIVE_BIAS_OPTION,
        ...
        bias_mixture_config = self._matrix_bias_config(
    ...
    def _parametric_stack_config(
        ...
        weight_mixture_config: MatrixWeightsMixtureConfig,
        bias_mixture_config: MatrixBiasMixtureConfig | None,
