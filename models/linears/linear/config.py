...
SUBMODULE_HIDDEN_DIM: int = STACK_HIDDEN_DIM
...
SUBMODULE_BIAS_FLAG: bool = STACK_BIAS_FLAG
...
GATE_HIDDEN_DIM: int | None = GATE_STACK_HIDDEN_DIM
GATE_LAYER_NORM_POSITION: LayerNormPositionOptions | None = (
    GATE_STACK_LAYER_NORM_POSITION
)
GATE_BIAS_FLAG: bool | None = GATE_STACK_BIAS_FLAG
...
HALTING_HIDDEN_DIM: int | None = HALTING_STACK_HIDDEN_DIM
HALTING_LAYER_NORM_POSITION: LayerNormPositionOptions | None = (
    HALTING_STACK_LAYER_NORM_POSITION
)
HALTING_BIAS_FLAG: bool | None = HALTING_STACK_BIAS_FLAG
...
MEMORY_HIDDEN_DIM: int | None = MEMORY_STACK_HIDDEN_DIM
MEMORY_LAYER_NORM_POSITION: LayerNormPositionOptions | None = (
    MEMORY_STACK_LAYER_NORM_POSITION
)
MEMORY_BIAS_FLAG: bool | None = MEMORY_STACK_BIAS_FLAG
...
RECURRENT_GATE_HIDDEN_DIM: int | None = RECURRENT_GATE_STACK_HIDDEN_DIM
RECURRENT_GATE_LAYER_NORM_POSITION: LayerNormPositionOptions | None = (
    RECURRENT_GATE_STACK_LAYER_NORM_POSITION
)
RECURRENT_GATE_BIAS_FLAG: bool | None = RECURRENT_GATE_STACK_BIAS_FLAG
...
RECURRENT_HALTING_HIDDEN_DIM: int | None = RECURRENT_HALTING_STACK_HIDDEN_DIM
RECURRENT_HALTING_LAYER_NORM_POSITION: LayerNormPositionOptions | None = (
    RECURRENT_HALTING_STACK_LAYER_NORM_POSITION
)
RECURRENT_HALTING_BIAS_FLAG: bool | None = RECURRENT_HALTING_STACK_BIAS_FLAG
