...
from models.transformer_encoder.vit_linear import Experiment, ExperimentOptions

if __name__ == "__main__":
    parser = get_experiment_parser(ExperimentOptions.names(), "models.transformer_encoder.vit_linear")
