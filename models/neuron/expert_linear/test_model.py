...
class TestNeuronExpertLinearModel(unittest.TestCase):
    ...
    def test_public_imports_and_cli_resolution(self):
        ...
        self.assertEqual(Experiment()._public_model_id(), "neuron/expert_linear")
    ...
    def test_hidden_flat_overrides_build_locally(self):
        cfg = NeuronExpertLinearConfigBuilder(
            batch_size=3,
            learning_rate=0.02,
            input_dim=8,
            hidden_dim=12,
    ...
    def test_grouped_cluster_capacity_matches_flat_values(self):
        ...
        flat = NeuronExpertLinearConfigBuilder(
            hidden_dim=12,
            cluster_x_axis_total_neurons=6,
            cluster_y_axis_total_neurons=5,
            cluster_z_axis_total_neurons=2,
        ...
        grouped = NeuronExpertLinearConfigBuilder(
            hidden_dim=12,
    ...
    def test_cluster_terminal_top_k_is_clamped(self):
        maximum = NeuronExpertLinearConfigBuilder(
        ...
        minimum = NeuronExpertLinearConfigBuilder(
    ...
    def test_cluster_halting_can_be_disabled(self):
        cfg = NeuronExpertLinearConfigBuilder(cluster_halting_flag=False).build()
