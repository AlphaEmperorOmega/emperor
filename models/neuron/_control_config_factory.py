...
from models.neuron._controller_stack_config_factory import (
    NeuronControllerStackConfigFactory,
)
from models.neuron.experiment_config import HiddenBlockConfig
...
class NeuronControlConfigFactory:
    ...
    def build(
        self,
        source_hidden_model_config: ConfigBase,
        hidden_dim: int,
    ) -> NeuronClusterConfig:
