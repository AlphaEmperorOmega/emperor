...
class ModelMetadata:
    ...
    def dataset_options_for_task(
        ...
        resolved_task = (
            self.default_experiment_task if task is None else resolve_experiment_task(task)
        )
...
def load_model_metadata(model_name: str) -> ModelMetadata:
    ...
    return load_model_metadata_from_module_path(module_path, model_name=model_name)
