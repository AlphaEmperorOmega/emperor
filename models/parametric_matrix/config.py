...
# Router
ROUTER_LAYER_STACK_OPTION: LinearLayerStackOptions = LinearLayerStackOptions.ADAPTIVE
ROUTER_HIDDEN_DIM: int = 256
ROUTER_NUM_LAYERS: int = 2
ROUTER_ACTIVATION: ActivationOptions = ActivationOptions.GELU
ROUTER_LAYER_NORM_POSITION: LayerNormPositionOptions = LayerNormPositionOptions.DEFAULT
ROUTER_RESIDUAL_FLAG: bool = False
ROUTER_DROPOUT_PROBABILITY: float = 0.1
...
ROUTER_ADAPTIVE_GENERATOR_STACK_DROPOUT_PROBABILITY: float = 0.1
