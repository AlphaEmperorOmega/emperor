...
from models.parametric_vector.config import (
    ExperimentConfig,
    BATCH_SIZE,
    LEARNING_RATE,
    INPUT_DIM,
    ...
    ROUTER_LAYER_STACK_OPTION,
    ROUTER_HIDDEN_DIM,
    ROUTER_NUM_LAYERS,
    ROUTER_ACTIVATION,
    ROUTER_LAYER_NORM_POSITION,
    ROUTER_RESIDUAL_FLAG,
    ROUTER_DROPOUT_PROBABILITY,
    ROUTER_BIAS_FLAG,
    ROUTER_NOISY_TOPK_FLAG,
    ROUTER_GENERATOR_DEPTH,
    ROUTER_DIAGONAL_OPTION,
    ROUTER_BIAS_OPTION,
    ROUTER_MEMORY_OPTION,
    ROUTER_MEMORY_SIZE_OPTION,
    ROUTER_MEMORY_POSITION_OPTION,
    ROUTER_ADAPTIVE_GENERATOR_STACK_HIDDEN_DIM,
    ROUTER_ADAPTIVE_GENERATOR_STACK_NUM_LAYERS,
    ROUTER_ADAPTIVE_GENERATOR_STACK_ACTIVATION,
    ROUTER_ADAPTIVE_GENERATOR_STACK_RESIDUAL_FLAG,
    ROUTER_ADAPTIVE_GENERATOR_STACK_DROPOUT_PROBABILITY,
    SAMPLER_NUM_EXPERTS,
    SAMPLER_TOP_K,
    SAMPLER_THRESHOLD,
...
class ExperimentPresets(ExperimentPresetsBase):
    ...
    def _preset(
        ...
        router_layer_stack_option: LinearLayerStackOptions = ROUTER_LAYER_STACK_OPTION,
        router_hidden_dim: int = ROUTER_HIDDEN_DIM,
        router_num_layers: int = ROUTER_NUM_LAYERS,
        router_activation: ActivationOptions = ROUTER_ACTIVATION,
        router_layer_norm_position: LayerNormPositionOptions = ROUTER_LAYER_NORM_POSITION,
        router_residual_flag: bool = ROUTER_RESIDUAL_FLAG,
        router_dropout_probability: float = ROUTER_DROPOUT_PROBABILITY,
        router_bias_flag: bool = ROUTER_BIAS_FLAG,
        router_noisy_topk_flag: bool = ROUTER_NOISY_TOPK_FLAG,
        router_generator_depth: DynamicDepthOptions = ROUTER_GENERATOR_DEPTH,
        router_diagonal_option: DynamicDiagonalOptions = ROUTER_DIAGONAL_OPTION,
        router_bias_option: DynamicBiasOptions = ROUTER_BIAS_OPTION,
        router_memory_option: LinearMemoryOptions = ROUTER_MEMORY_OPTION,
        router_memory_size_option: LinearMemorySizeOptions = ROUTER_MEMORY_SIZE_OPTION,
        router_memory_position_option: LinearMemoryPositionOptions = ROUTER_MEMORY_POSITION_OPTION,
        router_adaptive_generator_stack_hidden_dim: int = ROUTER_ADAPTIVE_GENERATOR_STACK_HIDDEN_DIM,
        router_adaptive_generator_stack_num_layers: int = ROUTER_ADAPTIVE_GENERATOR_STACK_NUM_LAYERS,
        router_adaptive_generator_stack_activation: ActivationOptions = ROUTER_ADAPTIVE_GENERATOR_STACK_ACTIVATION,
        router_adaptive_generator_stack_residual_flag: bool = ROUTER_ADAPTIVE_GENERATOR_STACK_RESIDUAL_FLAG,
        router_adaptive_generator_stack_dropout_probability: float = ROUTER_ADAPTIVE_GENERATOR_STACK_DROPOUT_PROBABILITY,
        sampler_num_experts: int = SAMPLER_NUM_EXPERTS,
        ...
        sampler_noisy_topk_flag: bool = SAMPLER_NOISY_TOPK_FLAG,
