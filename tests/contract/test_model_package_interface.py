...
_ORDERING_DIGEST_BY_PACKAGE = {
    ...
    "transformer/linear": (
        "eb3638eda296900d4c63e3f2cf03b137fb17d04a1d44dff9ff9ecadfe9111e2a",
        776,
        8,
    ),
    "transformer/linear_adaptive": (
        "df02dee56a2bb85086d57266bb20646843dcddca914123379245eafdb869e9ee",
        2978,
        16,
    ),
    "transformer/expert_linear": (
        "93ec1d5f29f4fee7a5697110133caa2a16ec6609e7701e462327ce943ddfbf81",
        912,
        8,
    ),
    "transformer/expert_linear_adaptive": (
        "fc7efb45df5932b19cb0a540842cc1577fd9e528923119fe0b4e1e536ba5fd56",
        3328,
        26,
    ),
    "vit/linear": (
