...
EXPECTED_OWNERS = {
    ...
    "SoftHalting": "emperor.halting._variants.soft",
    "SoftHaltingState": "emperor.halting._variants.soft",
    "StickBreaking": "emperor.halting._variants.stick_breaking",
    "StickBreakingState": "emperor.halting._variants.stick_breaking",
...
private_modules = (
    ...
    "emperor.halting._variants",
    "emperor.halting._variants.soft",
    "emperor.halting._variants.stick_breaking",
