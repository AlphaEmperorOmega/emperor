...
import models.neuron.expert_linear_adaptive.dataset_options as dataset_options
import torch
...
from models.neuron.expert_linear_adaptive._hidden_block import (
    HiddenBlockAdapter,
    HiddenBlockConfig,
)
...
class TestNeuronExpertLinearAdaptiveModel(unittest.TestCase):
    ...
    def test_builder_wraps_package_local_hidden_block(self):
        cfg = NeuronExpertLinearAdaptiveConfigBuilder().build()
    ...
    def test_hidden_flat_overrides_build_locally(self):
        cfg = NeuronExpertLinearAdaptiveConfigBuilder(
            batch_size=3,
            learning_rate=0.02,
            input_dim=8,
            hidden_dim=12,
    ...
    def test_grouped_cluster_capacity_matches_flat_values(self):
        ...
        flat = NeuronExpertLinearAdaptiveConfigBuilder(
            hidden_dim=12,
            cluster_x_axis_total_neurons=6,
            cluster_y_axis_total_neurons=5,
            cluster_z_axis_total_neurons=2,
        ...
        grouped = NeuronExpertLinearAdaptiveConfigBuilder(
            hidden_dim=12,
    ...
    def test_cluster_terminal_top_k_is_clamped(self):
        maximum = NeuronExpertLinearAdaptiveConfigBuilder(
        ...
        minimum = NeuronExpertLinearAdaptiveConfigBuilder(
