...
def _build_config(**runtime_defaults):
    runtime = model_package("neuron/expert_linear_adaptive").bind_runtime_defaults(
        runtime_defaults
    )
    return NeuronExpertLinearAdaptiveConfigBuilder(runtime=runtime).build()
...
class TestNeuronExpertLinearAdaptiveModel(unittest.TestCase):
    ...
    def test_all_presets_build_from_local_definitions(self):
        presets = model_package("neuron/expert_linear_adaptive").presets
    ...
    def test_flat_cluster_capacity_binds_to_typed_runtime_options(self):
        ...
        NeuronExpertLinearAdaptiveConfigBuilder(runtime=runtime).build()
