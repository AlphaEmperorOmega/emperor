...
class InspectorGraphTests(unittest.TestCase):
    def test_historical_checkpoint_invalid_preset_maps_to_workbench_error(
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with self.assertRaisesRegex(
                ...
                InspectionService(run_history).inspect_payload(
                    model_type="linears",
                    model="linear",
                    preset="missing",
                    dataset="Mnist",
    ...
    def test_inspection_service_uses_saved_log_run_params(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            default_result = service.inspect_payload(
                model_type="linears",
                model="linear",
                preset="baseline",
                dataset="Mnist",
            ...
            historical_semantic_result = service.inspect(
                model_type="linears",
                model="linear",
                preset="baseline",
                dataset="Mnist",
            ...
            historical_result = inspection_result_payload(historical_semantic_result)
    ...
    def test_inspection_service_uses_checkpoint_shapes_for_log_run_graph(
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            preset_result = service.inspect_payload(
                model_type="linears",
                model="linear",
                preset="baseline",
                dataset="Mnist",
