...
import { SelectedNodeDetailsView } from "@/features/workbench/components/graph/selected-node-details-view";
    ...
    : activeLinearTrainingJob
      ...
      : historicalRunTagsLoading
        ...
        : historicalRuns.length > 0
          ...
          : "Start a workbench training job or select a historical run with monitor tags";
