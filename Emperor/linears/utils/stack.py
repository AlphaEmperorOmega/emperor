...
class LinearLayerStack(Module):
    def __init__(
        ...
        super().__init__()
        self.cfg = cfg
        self.overrides = self.__override_config(overrides)
        self.identifier = "layer_stack_config"
        self.model = self.__create_multi_layer_model()
...
class AdaptiveLinearLayerStack(Module):
    def __init__(
        self,
        cfg: "LayerStackConfig | ModelConfig",
        overrides: "LayerStackConfig | None" = None,
    ...
    def __override_config(
        ...
        if overrides is None:
            return LayerStackConfig(model_type=LinearLayerOptions.ADAPTIVE)
        overrides.model_type = LinearLayerOptions.BASE
        return overrides
