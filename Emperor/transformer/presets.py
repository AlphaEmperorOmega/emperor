...
class TransformerPresets:
    ...
    def transformer_feed_forward_preset(
        ...
        projector_experts_stack_num_layers=2,
        projector_experts_stack_activation=ActivationOptions.RELU,
        projector_experts_stack_residual_flag=False,
        projector_experts_stack_dropout_probability=0.0,
        ...
        if layer_stack_option == MixtureOfExpertsStackOptions.BASE:
            projector_config = MixtureOfExpertsPresets.experts_stack_preset(
                ...
                experts_stack_activation=projector_experts_stack_activation,
                experts_stack_residual_flag=projector_experts_stack_residual_flag,
                experts_stack_dropout_probability=projector_experts_stack_dropout_probability,
