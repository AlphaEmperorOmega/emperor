    ...
    <EdgeCard className="rounded-card p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-3 text-[11px] text-ink-dim">
        <span className="flex items-center gap-1">
          <span className="inline-block h-2.5 w-2.5 rounded-[3px] bg-[#d7c9ff]" /> this neuron
        </span>
        <span className="flex items-center gap-1">
        ...
        <Button
          ...
          title={
            ...
            (canOpenMonitors
              ...
              : "Start a viewer training job before opening monitor charts")
          }
