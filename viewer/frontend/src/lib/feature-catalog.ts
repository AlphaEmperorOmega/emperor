...
export const IMPLEMENTED_FEATURES: ImplementedFeature[] = [
  {
    ...
    description: "Reports API availability and allows configured local viewer origins.",
  },
  {
    id: "model-discovery",
    category: "Backend API and discovery",
  ...
  },
  {
    ...
    description: "Wraps viewer API calls with typed helpers, validation, and error extraction.",
  },
  {
