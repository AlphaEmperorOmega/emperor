...
Use :mod:`viewer.backend.api.v1.routers.training` instead.
Remove this shim only after a repository import audit and migration note.
"""

from viewer.backend.api.v1.routers.training import router

COMPATIBILITY_STATUS = "deprecated"
REPLACEMENT_IMPORT = "viewer.backend.api.v1.routers.training"
