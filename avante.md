- When you need to modify code do not change the current file, create a new file that with the same name that ends in \_changes and write the changes there.
