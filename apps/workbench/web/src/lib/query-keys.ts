import type { TrainingRunPlanCreateInput } from "@/lib/api/training-jobs";
...
export type TrainingRunPlanQueryKeyInput = TrainingRunPlanCreateInput;
...
export const workbenchQueryKeys = {
  ...
  previewInspections: () => ["inspect", "preview"] as const,
  previewInspection: (requestKey: string) =>
    [...workbenchQueryKeys.previewInspections(), requestKey] as const,
