...
import { type MonitorChartsModal } from "@/features/workbench/components/monitor/monitor-charts-modal";
...
export const LazyMonitorChartsModal = dynamic<LazyMonitorChartsModalProps>(
  () =>
    import("@/features/workbench/components/monitor/monitor-charts-modal").then(
