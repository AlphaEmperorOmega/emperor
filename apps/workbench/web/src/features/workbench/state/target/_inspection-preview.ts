...
type InspectModel = typeof import("@/lib/api/inspection").inspectModel;
const inspectModel: InspectModel = createLazyFunction(() =>
  import("@/lib/api/inspection").then((module) => module.inspectModel),
);
