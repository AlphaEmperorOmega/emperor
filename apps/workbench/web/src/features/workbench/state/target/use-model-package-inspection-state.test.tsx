    ...
    return {
      ...
      setPersistedTargetSelection: (
        selection: Parameters<
          typeof actual.setPersistedTargetSelection
        >[0],
      ) => {
        mocks.writeTargetSelection(selection);
        actual.setPersistedTargetSelection(selection);
      },
    };
  },
);

import type { ConfigField, DatasetGroup, MonitorOption } from "@/lib/api/models";
import type { ConfigSnapshotRecord } from "@/lib/api/config-snapshots";
