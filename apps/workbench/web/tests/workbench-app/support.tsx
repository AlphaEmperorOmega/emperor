...
const inspectResponse = {
  ...
  nodes: [
    ...
    {
      id: "main_model.layers.0.gate_model",
      label: "Sequential",
      typeName: "Sequential",
    ...
    {
      id: "main_model.layers.0.layer_norm_module",
      label: "LayerNorm",
      typeName: "LayerNorm",
      path: "main_model.layers.0.layer_norm_module",
      graphRole: "internal",
      parameterCount: 256,
      details: {},
    },
    {
      id: "main_model.layers.0.dropout_module",
      label: "Dropout",
      typeName: "Dropout",
      path: "main_model.layers.0.dropout_module",
      graphRole: "internal",
      parameterCount: 0,
      details: {},
    },
  ...
  edges: [
    ...
    {
      id: "main_model.layers.0-main_model.layers.0.gate_model",
      source: "main_model.layers.0",
      target: "main_model.layers.0.gate_model",
    },
    {
      id: "main_model.layers.0-main_model.layers.0.layer_norm_module",
      source: "main_model.layers.0",
      target: "main_model.layers.0.layer_norm_module",
    },
    {
      id: "main_model.layers.0-main_model.layers.0.dropout_module",
      source: "main_model.layers.0",
      target: "main_model.layers.0.dropout_module",
    },
    {
